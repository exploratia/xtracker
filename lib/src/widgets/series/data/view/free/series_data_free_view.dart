...
import 'table/series_data_free_table_view.dart';

class SeriesDataFreeView extends StatelessWidget {
  const SeriesDataFreeView(
  ...
  final List<FreeValue> seriesData;
  ...
  Widget build(BuildContext context) {
    switch (seriesViewMetaData.viewType) {
      case ViewType.table:
        return SeriesDataFreeTableView(
